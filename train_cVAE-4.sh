...
save_root_dir="./3DcVAE_asd-UKBB604-dim32" # "./trained_cVAE_3DCNN"
# NAME YOUR EXPERIMENT HERE
#trial_name="UKBB567_1"
  trial_name="4-RAE-ALL-train_480-val_120-HP-alpha_${alpha}-beta_${beta}-gamma_${gamma}-batch_size_${batch_size}"
#trial_name="test-RAE-batch_size_${batch_size}"
