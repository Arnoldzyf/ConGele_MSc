...
trial_name="Model-3"
#trial_name="KL_annealing-explode_${explode}-cycle_${cycle}-ALL-train_480-val_120-HP-alpha_${alpha}-beta_${beta}-gamma_${gamma}-batch_size_${batch_size}"
#trial_name="test-KL_annealing-batch_size_${batch_size}"
